          ...
          <nav className="navigation navigation--primary">
            <div className="navigation__item navigation__item--has-dropdown">
              ...
              <div className="dropdown-menu dropdown-menu--product on">
                ...
                <div className="dropdown-menu__section">
                  <div className="dropdown-menu__heading">Your Sales Toolkit</div>
                  ...
                  <a href="https://close.com/reporting/" className="dropdown-item">
                    <div className="dropdown-item__icon">
                      <img
                        src="https://close.com/static/img/icons/icon-product-menu-reporting-white.png?h=327e6a9f"
                        alt=""
                      />
                    </div>
                    <div className="dropdown-item__text">
                      <div className="dropdown-item__title">Reporting</div>
                      <div className="dropdown-item__description">
                  ...
                  <a
                    href="https://close.com/custom-fields-custom-activities/"
                    className="dropdown-item"
                  >
                    <div className="dropdown-item__icon">
                      <img
                        src="https://close.com/static/img/icons/icon-product-menu-custom2.png?h=7d9afee6"
                        alt=""
                      />
                    </div>
                    <div className="dropdown-item__text">
                      <div className="dropdown-item__title">Custom Fields &amp; Activities</div>
                      <div className="dropdown-item__description">
                        Personalize your CRM to your sales process
                      </div>
                    </div>
                  </a>
                </div>
            ...
            <div className="navigation__item navigation__item--has-dropdown">
              ...
              <div className="dropdown-menu dropdown-menu--solutions on">
                <div className="dropdown-menu__section">
                  <div className="dropdown-menu__heading">Your Sales Approach</div>
                ...
                <div className="dropdown-menu__section">
                  <div className="dropdown-menu__heading">Industry Use Cases</div>
                  <a href="https://close.com/saas-crm/" className="dropdown-item">
                    <div className="dropdown-item__icon">
                      <img
                        src="https://close.com/static/img/icons/icon-product-menu-saas.png?h=465a118f"
                        alt=""
                      />
                    </div>
                    <div className="dropdown-item__text">
                      <div className="dropdown-item__title">SaaS</div>
                      <div className="dropdown-item__description">
                        Multiply your MRR with the CRM built for SaaS
                      </div>
                    </div>
                  </a>
                  <a href="https://close.com/financial-services-crm/" className="dropdown-item">
                    <div className="dropdown-item__icon">
                      <img
                        src="https://close.com/static/img/icons/icon-product-menu-financial.png?h=c1b4e7a5"
                        alt=""
                      />
                    </div>
                    <div className="dropdown-item__text">
                      <div className="dropdown-item__title">Financial Services</div>
                      <div className="dropdown-item__description">Turn more leads into revenue</div>
                    </div>
                  </a>
                  <a href="https://close.com/insurance-crm/" className="dropdown-item">
                    <div className="dropdown-item__icon">
                      <img
                        src="https://close.com/static/img/icons/icon-product-menu-insurance.png?h=9334913d"
                        alt=""
                      />
                    </div>
                    <div className="dropdown-item__text">
                      <div className="dropdown-item__title">Insurance</div>
                      <div className="dropdown-item__description">
                        Keep clients renewing year after year
                      </div>
                    </div>
                  </a>
                </div>
            ...
            <div className="navigation__item navigation__item--has-dropdown">
              ...
              <div className="dropdown-menu dropdown-menu--resources on">
                <div className="dropdown-menu__section dropdown-menu__section--full">
                  ...
                  <a href="/newsletter/" className="dropdown-item">
                    <div className="dropdown-item__text">
